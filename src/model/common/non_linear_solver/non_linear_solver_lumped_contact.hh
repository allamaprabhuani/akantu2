...
#ifndef AKANTU_NON_LINEAR_SOLVER_LUMPED_CONTACT_HH_
#define AKANTU_NON_LINEAR_SOLVER_LUMPED_CONTACT_HH_

namespace akantu {

class NonLinearSolverLumpedContact : public NonLinearSolverLumped {
  /* ------------------------------------------------------------------------ */
...
#endif /* AKANTU_NON_LINEAR_SOLVER_LUMPED_CONTACT_HH_ */
