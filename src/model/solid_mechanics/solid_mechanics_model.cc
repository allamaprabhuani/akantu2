...
void SolidMechanicsModel::solveContactStep(contact_data& cd, SolidMechanicsModel::SearchBase *sf, const PostAssemblyFunctor& paf) {
	...
	typedef typename contact_data::real_map real_map;
  ...
  // converged solution of Lagrange multipliers
	...
	do {
		...
		do {
			...
			converged = this->testConvergence <criteria> (cd[Newton_tol], nerror);
...
template void akantu::SolidMechanicsModel::solveContactStep <(akantu::SolveConvergenceMethod)0, (akantu::SolveConvergenceCriteria)1, akantu::ContactData <2, akantu::SolidMechanicsModel>, akantu::SolidMechanicsModel::PostAssemblyEmptyFunctor>(akantu::ContactData <2, akantu::SolidMechanicsModel>&, akantu::SolidMechanicsModel::SearchBase *, akantu::SolidMechanicsModel::PostAssemblyEmptyFunctor const&);
...
//      
////      cout<<"uzawa_converged -> "<<uzawa_converged<<endl;
//      
//      // solve
//      solve<NewmarkBeta::_displacement_corrector > (*increment);
//      
...
//
//
//template void akantu::SolidMechanicsModel::solveContactStep<(akantu::SolveConvergenceMethod)0, (akantu::SolveConvergenceCriteria)1, akantu::ContactData<2, akantu::SolidMechanicsModel> >(akantu::ContactData<2, akantu::SolidMechanicsModel>&, double, unsigned int);
