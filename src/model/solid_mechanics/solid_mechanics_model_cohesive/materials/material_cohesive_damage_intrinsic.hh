 ...
 */
template <Int dim> class MaterialCohesiveDamageIntrinsic : public MaterialCohesiveDamage {
  /* ------------------------------------------------------------------------ */
...
#include "material_cohesive_damage_intrinsic_inline_impl.hh"

#endif /* AKANTU_MATERIAL_COHESIVE_DAMAGE_INTRINSIC_HH_ */
