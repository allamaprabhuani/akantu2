/**
 * @file   material_cohesive_bilinear_friction.cc
 *
...
/* -------------------------------------------------------------------------- */
#include "material_cohesive_bilinear_friction.hh"
...
MaterialCohesiveBilinearFriction<spatial_dimension>::
    MaterialCohesiveBilinearFriction(SolidMechanicsModel & model, const ID & id)
...
/* -------------------------------------------------------------------------- */
template <UInt spatial_dimension>
void MaterialCohesiveBilinearFriction<spatial_dimension>::initMaterial() {
  AKANTU_DEBUG_IN();
...
/* -------------------------------------------------------------------------- */
template <UInt spatial_dimension>
void MaterialCohesiveBilinearFriction<spatial_dimension>::computeTraction(
