...
MaterialCohesiveDamage<dim>::MaterialCohesiveDamage(SolidMechanicsModel & model,
  ...
  this->registerParam("k", beta, Real(0.), _pat_parsable | _pat_readable,
                      "Beta parameter");
...
/* -------------------------------------------------------------------------- */
template <Int dim> void MaterialCohesiveDamage<dim>::scaleInsertionTraction() {
  AKANTU_DEBUG_IN();
...
/* -------------------------------------------------------------------------- */
template <Int dim>
void MaterialCohesiveDamage<dim>::checkInsertion(bool check_only) {
  AKANTU_DEBUG_IN();
