...
#ifndef __AKANTU_MATERIAL_ELASTIC_LINEAR_ANISOTROPIC_HETEROGENEOUS_INLINE_IMPL_CC__
#define __AKANTU_MATERIAL_ELASTIC_LINEAR_ANISOTROPIC_HETEROGENEOUS_INLINE_IMPL_CC__
...
template <UInt dim>
inline void
MaterialElasticLinearAnisotropicHeterogeneous<dim>::computeTangentModuliOnQuad(
    Matrix<Real> & tangent, const Matrix<Real> & _C) const {
...
/* -------------------------------------------------------------------------- */
template <UInt dim>
inline void MaterialElasticLinearAnisotropicHeterogeneous<
    dim>::computePotentialEnergyOnQuad(const Matrix<Real> & grad_u,
...
#endif /* __AKANTU_MATERIAL_ELASTIC_LINEAR_ANISOTROPIC_HETEROGENEOUS_INLINE_IMPL_CC__ \
        */
