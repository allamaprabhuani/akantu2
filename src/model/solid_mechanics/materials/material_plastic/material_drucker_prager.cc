...
void MaterialDruckerPrager<spatial_dimension>::initialize() {
  ...
  this->registerParam("hydrostatic_min", hydrostatic_min, Real(1.), _pat_parsable | _pat_modifiable,
		      "Minimum hydrostatic stress");
  this->registerParam("deviatoric_max", deviatoric_max, Real(1.), _pat_parsable | _pat_modifiable,
