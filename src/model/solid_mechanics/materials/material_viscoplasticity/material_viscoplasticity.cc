...
MaterialViscoPlasticity<spatial_dimension>::MaterialViscoPlasticity(SolidMechanicsModel & model, const ID & id) :
  Material(model, id),
...
/* -------------------------------------------------------------------------- */
template<UInt spatial_dimension>
void MaterialViscoPlasticity<spatial_dimension>::initMaterial() {
    AKANTU_DEBUG_IN();
...
/* -------------------------------------------------------------------------- */
template<UInt spatial_dimension>
void MaterialViscoPlasticity<spatial_dimension>::updateInternalParameters() {
...
/* -------------------------------------------------------------------------- */
template<UInt spatial_dimension>
void MaterialViscoPlasticity<spatial_dimension>::computeStress(ElementType el_type, GhostType ghost_type) {
    AKANTU_DEBUG_IN();
...
/* -------------------------------------------------------------------------- */
template<UInt spatial_dimension>
Real MaterialViscoPlasticity<spatial_dimension>::getPushWaveSpeed() const {
    return sqrt((lambda + 2 * mu) / rho);
}

/* -------------------------------------------------------------------------- */
template<UInt spatial_dimension>
Real MaterialViscoPlasticity<spatial_dimension>::getShearWaveSpeed() const {
    return sqrt(mu / rho);
}
