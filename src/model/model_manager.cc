 ...
 */
template <class BP, bool AP, template <class> class CP>
uint32_t Contact_model_manager<BP, AP, CP>::solve_quartic(Real a, Real b, Real c, Real d,
...
template uint32_t Contact_model_manager<Sphere, true, Cost_functor>::solve_quartic(double, double, double, double, double*, double*, double*, double*);
 ...
 */
template <class BP, bool AP, template <class> class CP>
uint32_t Contact_model_manager2<BP, AP, CP>::solve_quartic(Real a, Real b, Real c, Real d,
                                                          Real *x0, Real *x1, Real *x2, Real *x3 )
{
  Real u[3];
  Real aa, pp, qq, rr, rc, sc, tc, mt;
...
template uint32_t Contact_model_manager2<Sphere, true, Cost_functor>::solve_quartic(double, double, double, double, double*, double*, double*, double*);
