 ...
 * @date   Wed Jul 30 12:14:00 2013
 *
 * @brief  non-smooth contact
 *
 * @section LICENSE
 *
...
#ifndef __AKANTU_NS_CONTACT_MANAGER_HH__
#define __AKANTU_NS_CONTACT_MANAGER_HH__
...
class NS_contact_explicit : public IntegrationScheme2ndOrder {

public:
  NS_contact_explicit(Real alpha, Real beta) : beta(beta), alpha(alpha), k(0.), h(0.) {};
  ~NS_contact_explicit(){};
...
class NS_contact_model_manager : public Model_manager<SolidMechanicsModel>, public Kinematic_traits<accel> {
...
private:
  ...
  friend std::ostream& operator<<(std::ostream& os, const NS_contact_model_manager& mm) {
...
#endif /* __AKANTU_NS_CONTACT_MANAGER_HH__ */
