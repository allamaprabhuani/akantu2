...
def reference_setup():
    mesh_file = 'prototype_internodes/mesh/contact2_p1_0_05.msh'
...
def test_assembleInterfaceMass():
    ...
    M1b = contact_model.testAssembleInterfaceMass(initial_master_node_group)
...
#     # reference
#     ref_model, mesh, ref_data = reference_setup()
#     positions_new_ref = solve_step_direct(ref_model, ref_data, nb_iter=1) 
...
#     positions_new = solid.getCurrentPosition()[:ref_data['nb_dofs']]
