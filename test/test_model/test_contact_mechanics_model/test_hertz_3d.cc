...
int main(int argc, char *argv[]) {
  ...
  solid.applyBC(BC::Dirichlet::FixedValue(0.0, _z), "bot_body");
  
  solid.applyBC(BC::Dirichlet::FixedValue(0.0, _x), "top_surface");
  solid.applyBC(BC::Dirichlet::FixedValue(0.0, _y), "top_surface");
  solid.applyBC(BC::Dirichlet::FixedValue(0.0, _z), "top_surface");
  ...
  coupler.setBaseName("test-hertz-3d");
