...
Point(9)  = {0.05, 0.05, 1.001, h1};
Point(10) = {0.95, 0.05, 1.001, h1};
Point(11) = {0.95, 0.95, 1.001, h1};
Point(12) = {0.05, 0.95, 1.001, h1};
Point(13) = {0.05, 0.05, 2.001, h1};
Point(14) = {0.95, 0.05, 2.001, h1};
Point(15) = {0.95, 0.95, 2.001, h1};
Point(16) = {0.05, 0.95, 2.001, h1};
