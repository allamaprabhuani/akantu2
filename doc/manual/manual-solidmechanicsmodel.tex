...
\akantu which are named \code{MaterialSelector},
\code{DefaultMaterialSelector}, \code{MeshDataMaterialSelector} and
\code{DefaultMaterialCohesiveSelector}. By default, \akantu assigns
...
elements which is called \code{DefaultMaterialCohesiveSelector} and it
inherits its properties from \code{DefaultMaterialSelector}. This
...
then \code{DefaultMaterialSelector} is used by default.
...
%   selector first checks if an element is a cohesive element or a
%   facet. If there is, then the first cohesive material in the material
...
%   cohesive element or an element facet, then
