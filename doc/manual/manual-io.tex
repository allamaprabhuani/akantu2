...
object that is used to dump \code{VTK} files. These files can be visualized in softwares such
...
\code{VTK} file as elemental data. To do this, the default behavior averages the
...
\code{addDumpField*} or \code{removeDumpField} before the \code{dump}.
