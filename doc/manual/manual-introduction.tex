...
only developers) can criticise the implementation details.
...
vectorialization for low level layers. Thus, Akantu benefits the
inheritance and polymorphism mechanisms without the counter
part of having virtual calls within the critical loops. 
This coding philosophy, which was demonstrated in the past to be really 
efficient, is quite inovative in the field of \textit{Finite Element} softwares. \\
