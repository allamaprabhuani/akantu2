...
SolidMechanicsModelRVE::SolidMechanicsModelRVE(
    Mesh & mesh, bool use_RVE_mat_selector, UInt nb_gel_pockets,
    UInt dim, const ID & id, const MemoryID & memory_id)
...
//   /// storage for the coordinates of a given node and the displacement that
//   will
//   /// be applied
...
// /* --------------------------------------------------------------------------
//  */
// Real SolidMechanicsModelRVE::averageTensorField(UInt row_index, UInt
// col_index,
//                                                 const ID & field_type) {
//   AKANTU_DEBUG_IN();
//   auto & fem = this->getFEEngine("SolidMechanicsFEEngine");
...
//         const auto & stress_vec =
//         this->materials[m]->getStress(element_type); const auto & elem_filter
//         =
...
//                                         spatial_dimension *
//                                         spatial_dimension, "int_of_gradu");
...
//           /// strain are equal
//           average +=
//               int_eigen_gradu_vec(k, row_index * spatial_dimension +
//               col_index);
//       }
//     } else {
...
//                                                    Matrix<Real> &
//                                                    eff_stresses, Matrix<Real>
//                                                    & eff_strains, const UInt
//                                                    test_no) {
//   AKANTU_DEBUG_IN();
...
//     for (auto & element_type : filter_map.elementTypes(spatial_dimension,
//     gt)) {
