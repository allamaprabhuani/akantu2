...
#ifndef __AKANTU_RICE_KUWANO_MODIFIED_HH__
#define __AKANTU_RICE_KUWANO_MODIFIED_HH__
...
class RiceKuwanoModified : public VelocityDependentFricCoef {
  /* ------------------------------------------------------------------------ */
  /* Constructors/Destructors                                                 */
  /* ------------------------------------------------------------------------ */
public:

  RiceKuwanoModified(ContactRigid & contact,
...
inline std::ostream & operator <<(std::ostream & stream, const RiceKuwanoModified & _this)
{
...
#endif /* __AKANTU_RICE_KUWANO_MODIFIED_HH__ */
