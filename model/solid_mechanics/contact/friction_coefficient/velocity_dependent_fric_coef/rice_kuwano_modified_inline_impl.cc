...
/* -------------------------------------------------------------------------- */
inline Real RiceKuwanoModified::computeFricCoef(UInt impactor_node_index) {
  AKANTU_DEBUG_IN();
  ...
  friction_coefficient = (this->static_friction_coefficient - this->dynamic_friction_coefficient) * reference_velocity / (rel_sliding_vel + reference_velocity);
