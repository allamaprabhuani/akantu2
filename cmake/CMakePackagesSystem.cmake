...
macro(add_all_packages package_dir)
  ...
  file(GLOB _package_list "${package_dir}/*.cmake")
  ...
  cmake_debug_message(PackagesSystem "add_all_packages: ALL FILE LIST : ${_release_all_file}")

  #check if there are some file in the release that are not registered in a package
  file(GLOB_RECURSE __all_files "*.cc" "*.hh" "*.c" "*.h")
  set(_all_files)
  foreach(_file ${__all_files})
    if("${_file}" MATCHES  "${PROJECT_SOURCE_DIR}/src")
      file(RELATIVE_PATH __file ${PROJECT_SOURCE_DIR}/src ${_file})
