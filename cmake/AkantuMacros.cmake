  ...
  if(${_option_name})
    ...
    if(${_u_package}_FOUND)
      ...
      if(DEFINED ${_u_package}_INCLUDE_DIR)
        ...
        set(AKANTU_${_u_package}_INCLUDE_DIR ${${_u_package}_INCLUDE_DIR})
      else()
        list(APPEND AKANTU_EXTERNAL_LIB_INCLUDE_DIR ${${_u_package}_INCLUDE_PATH})
        set(AKANTU_${_u_package}_INCLUDE_DIR ${${_u_package}_INCLUDE_PATH})
      endif()
      list(APPEND AKANTU_EXTERNAL_LIBRARIES ${${_u_package}_LIBRARIES})
      set(AKANTU_${_u_package}_LIBRARIES ${${_u_package}_LIBRARIES})
