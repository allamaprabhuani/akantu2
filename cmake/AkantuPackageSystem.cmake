...
macro(add_all_packages package_dir)
  ...
  foreach(_pkg ${_akantu_package_list})
    ...
    string(TOUPPER "${_pkg_suffix}" _pkg_suffix)
...
macro(add_package_dependecies PKG DEP)
  package_opt_name (${PKG} _opt_name)
  ...
  if(${_opt_name})
    ...
    if(DEFINED ${_dep_name}_OLD)
      akantu_message("add_package_dependecies: Restore state ${_dep_name}:${${_dep_name}}")
      set(${_dep_name} ${_dep_name}_OLD CACHE BOOL "${_dep_desc}" FORCE)
      unset(${_dep_name}_OLD CACHE)
    endif(DEFINED ${_dep_name}_OLD)
  endif()
endmacro()
