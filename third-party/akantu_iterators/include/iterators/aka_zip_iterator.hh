...
public:
  ...
  explicit ZipIterator_(tuple_t iterators) : iterators(std::move(iterators)) {}

  /* ---------------------------------------------------------------------- */
  template <class iterator_category_ = iterator_category,
            std::enable_if_t<aka::is_iterator_category_at_least<
                iterator_category_, std::bidirectional_iterator_tag>::value> * =
                nullptr>
  ...
  template <class iterator_category_ = iterator_category,
            std::enable_if_t<aka::is_iterator_category_at_least<
                iterator_category_, std::random_access_iterator_tag>::value> * =
                nullptr>
  ...
  decltype(auto) extend(std::index_sequence<Is...> && /*unused*/,
    ...
    return append(
        ...
        std::forward<decltype(std::get<Is>(
            std::forward<OtherContainers>(other_containers)))>(
            std::get<Is>(std::forward<OtherContainers>(other_containers)))...);
  }
...
template <
    ...
    std::enable_if_t<not tuple::is_named_tuple<std::decay_t<Tuple>>::value> * =
        nullptr>
...
template <class Tuple, std::size_t... Is,
          std::enable_if_t<tuple::is_named_tuple<std::decay_t<Tuple>>::value>
              * = nullptr>
auto make_zip_from_tuple_impl(std::index_sequence<Is...> && /*unused*/,
                              Tuple &&tuple) -> decltype(auto) {
  return zip(
