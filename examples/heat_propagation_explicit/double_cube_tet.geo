...
Point(15) = {0.0, 0.0, -h-L, p};
Point(16) = {L, 0.0, -h-L, p};
Point(17) = {L, L, -h-L, p};
Point(18) = {0.0, L, -h-L, p};


Point(25) = {L/2-L2/2, L/2-L2/2, h, p};
Point(26) = {L/2+L2/2, L/2-L2/2, h, p};
Point(27) = {L/2+L2/2, L/2+L2/2, h, p};
Point(28) = {L/2-L2/2, L/2+L2/2, h, p};
...
Physical Volume(500) = {85};Coherence;
